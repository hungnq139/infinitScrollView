...
@ReactModule(name = MyReactScrollViewManager.REACT_CLASS)
public class MyReactScrollViewManager extends ViewGroupManager<ReactScrollView>
    implements MyReactScrollViewCommandHelper.ScrollCommandHandler<ReactScrollView> {

  public static final String REACT_CLASS = "RCTMyScrollView";
  ...
  public MyReactScrollViewManager() {
    this(null);
  }

  public MyReactScrollViewManager(@Nullable FpsListener fpsListener) {
  ...
  public @Nullable Map<String, Integer> getCommandsMap() {
    return MyReactScrollViewCommandHelper.getCommandsMap();
  }
  ...
  public void scrollTo(
      ReactScrollView scrollView, MyReactScrollViewCommandHelper.ScrollToCommandData data) {
    if (data.mAnimated) {
  ...
  public void scrollToEnd(
      ReactScrollView scrollView, MyReactScrollViewCommandHelper.ScrollToEndCommandData data) {
  ...
  public void autoScroll(
      ReactScrollView scrollView, MyReactScrollViewCommandHelper.AutoScrollCommandData data) {
    // ScrollView always has one child - the scrollable area
//    int bottom = scrollView.getChildAt(0).getHeight() + scrollView.getPaddingBottom();
//    if (data.mAnimated) {
//      scrollView.smoothScrollTo(scrollView.getScrollX(), bottom);
...
//    }
  ...
  public void disableAutoScroll(ReactScrollView scrollView) {
  }
