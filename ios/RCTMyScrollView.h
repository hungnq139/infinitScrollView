...
/**
 * The `RCTMyScrollView` may have at most one single subview. This will ensure
...
@interface RCTMyScrollView (Internal)

- (void)updateContentOffsetIfNeeded;

@end

@interface RCTEventDispatcher (RCTMyScrollView)
